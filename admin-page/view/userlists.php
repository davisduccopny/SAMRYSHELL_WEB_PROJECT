                            ...
                            <table class="table  datanew">
                                ...
                                <?php foreach ($listusermanager as $listuser): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="me-3" href="newuseredit.php?usermanager_id=<?php echo $listuser['id']; ?>">
                                                <img src="assets/img/icons/edit.svg" alt="img">
                                            </a>
                                            <a class="me-3 confirm-text_usermanagerdelete" href="javascript:void(0);" data-usermanager-id="<?php echo $listuser['id']; ?>">
