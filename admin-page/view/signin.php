                    ...
                    <form method="post" onsubmit="LoginManager(event)" enctype="multipart/form-data" class="login-userset">
                        ...
                        <div class="form-login">
                            ...
                            <div class="form-addons">
                                <input type="text" id="EmailLoginManager" placeholder="Enter your email address" required>
                        ...
                        <div class="form-login">
                            ...
                            <div class="pass-group">
                                <input type="password" class="pass-input" id="passloginManager" placeholder="Enter your password" required>
                        ...
                        <div class="form-login">
                            <button type="submit" name="signin_manager" class="btn btn-login">Sign In</button>
                        </div>
                        <div class="signinform text-center">
                            <h4>Don’t have an account? <a href="./forgetpassword.php" class="hover-a">Sign Up</a></h4>
                        </div>
