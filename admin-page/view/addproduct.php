...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['submit'])) {
        ...
        if (
            ...
            $insertResult = $productModel->insertProduct($sku, $name, $price, $minQuantity, $quantity, $unit, $tax, $discount, $status, $description, $categoryID, $subcategoryID, $created_by, $short_description);
