...
<?php
  ...
  // require($_SERVER['DOCUMENT_ROOT'] . '/admin-page/model/email_model.php');
  // require($_SERVER['DOCUMENT_ROOT'] . '/admin-page/model/general_model.php');
...
function getGeneral($conn, $id) {
  // Sử dụng prepared statement để tránh các vấn đề về SQL Injection
  $query = "SELECT id, title, phone, image, email, currency, address,date, fax, date_format, time_zone, youtube, instagram, linkedin, facebook FROM general_setting WHERE id=?";
  $stmt = $conn->prepare($query);
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="images/image-8.png" alt="Icon" title="Icon" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 48%;max-width: 107.02px;" width="107.02" class="v-src-width v-src-max-width" />
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="images/image-6.png" alt="curve border" title="curve border" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;" width="600" class="v-src-width v-src-max-width" />
