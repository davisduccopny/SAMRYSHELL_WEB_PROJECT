...
class ProductModel {
    ...
    public function insertProduct($sku, $name, $price, $minQuantity, $quantity, $unit, $tax, $discount, $status, $description, $categoryID, $subcategoryID, $created_by, $short_description) {
      
        $slug = $this->createSlug($name);

        // Tạo truy vấn INSERT
        $query = "INSERT INTO product (sku, name, price, minium_quantity, quantity, unit, tax, discount, status, description, categoryproduct_id, subcategoryproduct_id, slug, created_by, short_description) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $this->conn->prepare($query);
        $stmt->bind_param("ssdiisddssiisss", $sku, $name, $price, $minQuantity, $quantity, $unit, $tax, $discount, $status, $description, $categoryID, $subcategoryID, $slug, $created_by, $short_description);

        // Thực hiện truy vấn
        return $stmt->execute();
        
    }
    public function insertTrashProduct($product_id,$sku, $name, $price, $minQuantity, $quantity, $unit, $tax, $discount, $status, $description, $categoryID, $subcategoryID,$slug, $created_by, $short_description) {

        // Tạo truy vấn INSERT
        $query = "INSERT INTO trash_product (product_id,sku, name, price, minium_quantity, quantity, unit, tax, discount, status, description, categoryproduct_id, subcategoryproduct_id, slug, created_by, short_description) VALUES (?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $this->conn->prepare($query);
        $stmt->bind_param("issdiisddssiiss",$product_id, $sku, $name, $price, $minQuantity, $quantity, $unit, $tax, $discount, $status, $description, $categoryID, $subcategoryID, $slug, $created_by, $short_description);
    ...
    public function updateProduct($id, $sku, $name, $price, $minQuantity, $quantity, $unit, $tax, $discount, $status, $description, $categoryID, $subcategoryID, $created_by, $short_description) {

        $slug = $this->createSlug($name);

        // Tạo truy vấn UPDATE
        $query = "UPDATE product SET sku=?, name=?, price=?, minium_quantity=?, quantity=?, unit=?, tax=?, discount=?, status=?, description=?, categoryproduct_id=?, subcategoryproduct_id=?, slug=?,created_by=?, short_description=? WHERE id=?";
        $stmt = $this->conn->prepare($query);
        $stmt->bind_param("ssdiisddssiisssi", $sku, $name, $price, $minQuantity, $quantity, $unit, $tax, $discount, $status, $description, $categoryID, $subcategoryID, $slug, $created_by, $short_description, $id);
    ...
    public function deleteProduct($id) {
        $sku = $name = $price = $minium_quantity = $quantity = $unit = $tax = $discount = $status = $description = $categoryproduct_id = $categorysub_name = $slug = $created_by= $short_description = null;
        ...
        $queryselect = "SELECT 
            ...
            p.created_by, p.short_description
        FROM product AS p
        ...
        $stmtselect->bind_result(
            ...
            $status, $description, $categoryproduct_id, $categorysub_name, $slug, $created_by,$short_description
        );
        ...
        $this->insertTrashProduct($id, $sku, $name, $price, $minium_quantity, $quantity, $unit, $tax, $discount, $status, $description, $categoryproduct_id, $categorysub_name, $slug, $created_by, $short_description);
    ...
    public function getProduct($id) {
        // Khai báo biến
        $subcategoryproduct_id= $sku = $name = $price = $minium_quantity = $quantity = $unit = $tax = $discount = $status = $description = $categoryproduct_id = $categorysub_name = $slug = $updated_at = $created_at = $created_by = $category_name = $category_link = $code =$image= $short_description=null;
        ...
        $query = "SELECT 
                    ...
                    c.name AS category_name, c.category_link, c.code, p.subcategoryproduct_id, p.short_description
                  FROM product AS p
        ...
        $stmt->bind_result(
            ...
            $updated_at, $created_at, $created_by, $category_name, $category_link, $code, $subcategoryproduct_id, $short_description
        );
    ...
    public function showProduct() {
        ...
        $query = "SELECT 
                    ...
                    ip.image ,c.image AS image_category, p.categoryproduct_id, p.short_description
                  FROM product AS p
                  JOIN categoryproduct AS c ON p.categoryproduct_id = c.categoryproduct_id
                  LEFT JOIN category_sub AS sc ON p.subcategoryproduct_id = sc.category_sub_id 
                  LEFT JOIN  (
        ...
        $stmt->bind_result(
            ...
            $updated_at, $created_at, $created_by, $category_name, $category_link, $code, $image, $image_category,$categoryproduct_id, $short_description
        );
    ...
    public function showProductFilter($categoryproduct_id = null, $minprice = null, $maxprice = null) {
        $id = $sku = $name = $price = $minium_quantity = $quantity = $unit = $tax = $discount = $image_category=
        $status = $description = $slug =
        $updated_at = $created_at = $created_by = $category_name = $category_link = $code =  $image= $categorysub_name= $categoryid =$short_description= null;
    ...
    public function getProductByIds($ids) {
        $id = $sku = $name = $price = $minium_quantity = $quantity = $unit = $tax = $discount = $image_category=
        $status = $description = $slug =
        $updated_at = $created_at = $created_by = $category_name = $category_link = $code =  $image= $categorysub_name=$short_description=null;
        ...
        $query = "SELECT 
                    ...
                    p.updated_at, p.created_at, p.created_by,
                    c.name AS category_name, c.category_link, c.code,
                    ip.image ,c.image AS image_category, p.short_description
                  FROM product AS p
                  JOIN categoryproduct AS c ON p.categoryproduct_id = c.categoryproduct_id
                  LEFT JOIN category_sub AS sc ON p.subcategoryproduct_id = sc.category_sub_id 
                  LEFT JOIN  (
        ...
        $stmt->bind_result(
            $id, $sku, $name, $price, $minium_quantity, $quantity, $unit, $tax, $discount,
            $status, $description, $categorysub_name, $slug,
            $updated_at, $created_at, $created_by, $category_name, $category_link, $code, $image, $image_category, $short_description
        );
    ...
    public function showProductsalelist() {
        ...
        $stmt->bind_result(
            $id, $sku, $name, $price, $minium_quantity, $quantity, $unit, $tax, $discount,
            $status, $description, $categorysub_name, $slug,
            $updated_at, $created_at, $created_by, $category_name, $category_link, $code, $image, $short_description
        );
